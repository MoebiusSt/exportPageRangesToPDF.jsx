...
var SCRIPT_VERSION = "2.05"; // Date: 2025-04-30
...
w.mainGroup.buttonGroup.settingsButton.onClick = function() {
    try {
        ...
        alert(__("Error in button click handler") + ": " + e.message);
    }
}; 
            ...
            if (DEBUG_MAC && $.os.indexOf("Mac") > -1) {
                try {
                    ...
                    var dateStr = now.getFullYear() + "-" + 
                                 ...
                                 now.getSeconds();
                    logFile.writeln("\n--- Debug Log " + dateStr + " ---");
                    logFile.writeln("Input Path: " + _path);
                    logFile.writeln("Base Path: " + settings.folder);
...
function getFormattedPath(inputPath, basePath) {
    try {
        ...
        // Einfache Fehlerbehandlung ohne Logging
